...
const PageDecoration = () => {
    return (
        <svg className='absolute top-0 md:left-0 -left-[40rem] md:max-w-[85%] md:min-h-fit min-h-[70px]' viewBox="0 0 1650 100" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <defs>
                <linearGradient id="paint0_linear_0_1" x1="659.987" y1="14.9412" x2="1649.5" y2="14.9412" gradientUnits="userSpaceOnUse">
                ...
                <linearGradient id="paint2_linear_0_1" x1="348.013" y1="33.9456" x2="1254.76" y2="33.9456" gradientUnits="userSpaceOnUse">
